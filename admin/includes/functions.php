            ...
            <div class="dig-addon-item" data-plugin="<?php echo $plugin['plugin']; ?>">
                <div class="dig-addon-par">
                    ...
                    <div class="dig_addon_btn_con">
                        ...
                        <input type="hidden" class="dig_plugin_slug" value="<?php $basename = explode('/', $plugin['plugin']);
                                           echo $basename[0]; ?>">
...
<div class="digits_activation_wrapper">
    <?php
        ...
        ?>
    <input type="hidden" name="dig_license_type" value="<?php echo esc_attr($license_type); ?>" />
    <?php
    ...
    <div class="dig_prchcde" <?php if (!empty($code)) {
        ...
        <div class="dig_purchase_code_submit_wrapper">
            <Button type="submit" class="dig_admin_submit" disabled><?php _e('Save', 'digits'); ?></Button>
        </div>
    </div>
...
<table class="form-table">
    <tr>
        ...
        <td class="dig_prst_btns">
            <input class="dig_prst_name" type="text" readonly value="<?php if (array_key_exists($preset, $presets_array)) {
                           echo $presets_array[$preset]['name'];
                       } ?>">
            <Button id="dig_open_preset_box" type="button" class="button"><?php _e('Select', 'digits'); ?></Button>
...
<div class="dig_admin_sec_head dig_admin_sec_head_margin dig_prst_clse_scrl">
    <span><?php _e('Form Type', 'digits'); ?></span>
</div>
            ...
            <div class="digits-form-type dig_trans">
                ...
                <label class="dig_type_item" for="dig_page_type1">
                    <div class="dig_style_types_gs">
                        <input value="1" name="dig_page_type" id="dig_page_type1" class="dig_type" type="radio" <?php if ($page_type == 1) {
                                echo 'checked';
                            } ?> />
                ...
                <label class="dig_type_item" for="dig_page_type2">
                    <div class="dig_style_types_gs">
                        <input value="2" name="dig_page_type" id="dig_page_type2" class="dig_type" type="radio" <?php if ($page_type == 2) {
                                echo 'checked';
                            } ?> />
                        <div class="dig_preset_sel">
                            <div class="dig_tick_center">
        ...
        <td>
            <div class="digits-form-type">
                <label class="dig_type_item" for="dig_modal_type1">
                    <div class="dig_style_types_gs">
                        <input value="1" name="dig_modal_type" id="dig_modal_type1" class="dig_type" type="radio" <?php if ($modal_type == 1) {
                                echo 'checked';
                            } ?> />
                        <div class="dig_preset_sel">
                            <div class="dig_tick_center">
                ...
                <label class="dig_type_item" for="dig_modal_type2">
                    <div class="dig_style_types_gs">
                        <input value="2" name="dig_modal_type" id="dig_modal_type2" class="dig_type" type="radio" <?php if ($modal_type == 2) {
                                echo 'checked';
                            } ?> />
                        <div class="dig_preset_sel">
                            <div class="dig_tick_center">
...
<table class="form-table">
    <tr>
        ...
        <td>
            ...
            <input type="text" name="image_attachment_id" id='image_attachment_id' value='<?php if (is_numeric($imgid)) {
                           if ($wid) {
                               echo $wid;
                           }
                       } else {
            ...
            <Button id="upload_image_button" type="button"
                class="button dig_img_chn_btn dig_imsr"><?php echo $imagechoose; ?></Button>
    ...
    <tr class="dig_page_type_2">
        ...
        <td>
            ...
            <input type="text" name="bg_image_attachment_id_left" id='bg_image_attachment_id_left' value='<?php if (is_numeric($imgid)) {
                           if ($wid) {
                               echo $wid;
                           }
                       } else {
            ...
            <Button id="bg_upload_image_button_left" type="button"
                class="button dig_img_chn_btn dig_imsr"><?php echo $imagechoose; ?></Button>
    ...
    <tr class="dig_page_type_2">
        ...
        <td>
            <input name="login_page_footer_text_color" type="text" class="bg_color"
                ...
                autocomplete="off" required data-alpha="true">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="bg_image_attachment_id" id='bg_image_attachment_id' value='<?php if (is_numeric($imgid)) {
                           if ($wid) {
                               echo $wid;
                           }
                       } else {
            ...
            <Button id="bg_upload_image_button" type="button"
                class="button dig_img_chn_btn dig_imsr"><?php echo $imagechoose; ?></Button>
        </td>
    </tr>
        ...
        <td>
            <div class="digits_box_shadow">
                <div>
                    ...
                    <div class="digits_box_shadow_inp">
                        <input id="lb_x" name="lb_x" type="number" value="<?php echo esc_attr($sx); ?>"
                            autocomplete="off" class="digits_disable_no_spinner" required maxlength="2">
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="digits_box_shadow_inp">
                        <input id="lb_spread" name="lb_spread" type="number" value="<?php echo esc_attr($sspread); ?>"
                            autocomplete="off" class="digits_disable_no_spinner" required maxlength="2">
                    </div>
                </div>
            </div>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="backcolor" class="bg_color" value="<?php echo $backcolor; ?>" data-alpha="true" />
        </td>
    </tr>
    ...
    <tr class="dig_page_type_2">
        ...
        <td>
            <input type="text" name="signup_button_border_color" class="bg_color"
                value="<?php echo $signup_button_border_color; ?>" data-alpha="true" />
        </td>
    </tr>
    ...
    <tr class="dig_page_type_2">
        ...
        <td>
            <input type="text" name="signup_button_text_color" class="bg_color"
                value="<?php echo $signup_button_text_color; ?>" data-alpha="true" />
        </td>
    </tr>
...
<table class="form-table">
    <tr>
        ...
        <td>
            <input name="bg_color_modal" type="text" class="bg_color" value="<?php echo $bgcolor; ?>" autocomplete="off"
                required data-alpha="true">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="bg_image_attachment_id_modal" id='bg_image_attachment_id_modal' value='<?php if (is_numeric($imgid)) {
                           if ($wid) {
                               echo $wid;
                           }
                       } else {
            ...
            <Button id="bg_upload_image_button_modal" type="button"
                class="button dig_img_chn_btn dig_imsr"><?php echo $imagechoose; ?></Button>
    ...
    <tr class="dig_modal_type_2">
        ...
        <td>
            ...
            <input type="text" name="bg_image_attachment_id_left_modal" id='bg_image_attachment_id_left_modal' value='<?php if (is_numeric($imgid)) {
                           if ($wid) {
                               echo $wid;
                           }
                       } else {
            ...
            <Button id="bg_upload_image_button_left_modal" type="button"
                class="button dig_img_chn_btn dig_imsr"><?php echo $imagechoose; ?></Button>
    ...
    <tr>
        ...
        <td>
            ...
            <div class="digits_box_shadow">
                ...
                <div>
                    <label for="lb_blur_modal" class="digits_box_shadow_label"><?php _e('Blur', 'digits'); ?></label>
                    <div class="digits_box_shadow_inp">
                        <input id="lb_blur_modal" name="lb_blur_modal" type="number"
                            value="<?php echo esc_attr($sblur); ?>" autocomplete="off" class="digits_disable_no_spinner"
                ...
                <div>
                    ...
                    <div class="digits_box_shadow_inp">
                        <input id="lb_spread_modal" name="lb_spread_modal" type="number"
                            value="<?php echo esc_attr($sspread); ?>" autocomplete="off"
                            class="digits_disable_no_spinner" required maxlength="2">
                    </div>
                </div>
            </div>
        </td>
    ...
    <tr>
        ...
        <td>
            <input name="lb_color_modal" class="bg_color" type="text" value="<?php echo $scolor; ?>" autocomplete="off"
                required data-alpha="true">
        </td>
    </tr>
    <tr>
    ...
    <tr class="dig_modal_type_2">
        ...
        <td>
            <input type="text" name="input_border_color_modal" class="bg_color"
                value="<?php echo $input_border_color; ?>" data-alpha="true" />
        </td>
    </tr>
    <tr class="dig_modal_type_2">
        <th scope="row"><label><?php _e('Input Text Color', 'digits'); ?> </label></th>
    ...
    <tr class="dig_modal_type_2">
        ...
        <td>
            <input type="text" name="signup_button_color_modal" class="bg_color"
                value="<?php echo $signup_button_color; ?>" data-alpha="true" />
        </td>
    </tr>
    <tr class="dig_modal_type_2">
        <th scope="row"><label><?php _e('Signup Button Border Color', 'digits'); ?> </label></th>
...
<div class="dig_presets_modal" id="dig_presets_box">
    <div id="dig_presets_modal_box">
        <div id="dig_presets_modal_head">
            ...
            <div id="dig_presets_modal_head_close" class="dig_presets_modal_head_close"><?php _e('CLOSE', 'digits'); ?>
            </div>
        </div>
        ...
        <?php
            ...
            ?>
        <input type="radio" id="dig_preset_custom" class="dig_preset" name="dig_preset" style="display: none;" value="0"
            data-lab="<?php _e('CUSTOM', 'digits'); ?>" <?php if ($preset == 0) {
                echo 'checked';
            } ?> />
...
<div class="multi_checkbox dig_admin_checkbox dig_admin_switch <?php echo $sel; ?>">
    <input type="checkbox" class="<?php echo esc_attr($name); ?> default_empty"
        ...
        data-id="<?php echo esc_attr($name . '_' . $key); ?>" <?php echo $sel; ?>
