...
<span class="dig-display_inline">
    ...
    <a href="https://melipayamak.com/" target="_blank">
        <img src="<?php echo melipayamak_logo_uri(); ?>" class="digits_admin_logo" />
...
//add by melipayamak
function melipayamak_logo_uri()
{
    return get_digits_asset_uri('/assets/images/Melipayamak-logo.svg');
}
    ...
    <div class="digits_admin_notice_buttons">
        ...
        <?php
            ...
            foreach ($links as $link) {
                ...
                ?>
        <a class="digits_admin_notice_button <?php echo $class; ?>" <?php echo $link_target; ?>
        ...
        <div class="dig_log_setge">
            ...
            <div class="dig_admin_left_side">
                <div class="dig_admin_left_side_content">
                    ...
                    <div class="dig_sts_logo">
                        ...
                        <div class="dig-tab-wrapper" id="digits-admin_tabs">
                            <div class="dig-tab-left dig-tab-left_item dig-tab_dashboard">
                                ...
                                <a href="?page=digits_settings&tab=dashboard" id="digits_dashboard"
                    ...
                    <div class="digits-settings_body">
                        ...
                        <div id="digits_setting_form_div" class="dig_settings_Form">
                            ...
                            <div class="dig_admin_tab_bg">
                                ...
                                <div data-tab="customfieldstab" data-attach="customfieldsNavTab"
                    ...
                    <Button id="digits_admin_submit" type="submit" class="dig_admin_submit dig_admin_floating_submit"
...
{
    ?>
<div class="digits-setting_save_indicator saved" style="display: none;">
