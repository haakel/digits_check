...
<div class="digits_login_form">
    ...
    <div id="dig-ucr-container" class="<?php if (is_rtl()) {
        ...
        if ($page_type == 2) {
            ...
            echo ' dig_pgmdl_1';
        } ?>" <?php if($page_type==2) echo 'data-placeholder="yes"';?>
...
function dig_show_fields($reg_custom_fields, $show_asterisk, $login_page = 1, $bgtype = null, $user_id = 0)
{
    ...
    <div class="digits-input-wrapper">
        <input type="<?php echo $inp_type; ?>" name="digits_reg_<?php echo $meta_key; ?>"
            placeholder="<?php echo esc_attr($placeholder);?>" id="digits_reg_<?php echo $meta_key . $rand; ?>"
...
// تنظیم مقدار آپشن به true
update_option('my_plugin_enable_addons', true);